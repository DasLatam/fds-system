...
// NextResponse puede fallar (en runtime y/o TS) si le pasamos directamente un Uint8Array.
// Convertimos a ArrayBuffer "exacto" para evitar SharedArrayBuffer y offsets.
...
export async function GET(req: NextRequest) {
  ...
  // dl.data.arrayBuffer() ya nos da un ArrayBuffer válido para Response.
...
export async function POST(req: NextRequest) {
  try {
    ...
    const pdfBody = u8ToArrayBuffer(pdfBytes);
